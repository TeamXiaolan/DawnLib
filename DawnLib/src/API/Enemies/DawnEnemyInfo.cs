...
{
    internal DawnEnemyInfo(NamespacedKey<DawnEnemyInfo> key, List<NamespacedKey> tags, EnemyType enemyType, DawnEnemyLocationInfo? outside, DawnEnemyLocationInfo? inside, DawnEnemyLocationInfo? daytime, TerminalNode? bestiaryNode, TerminalKeyword? nameKeyword, IDataContainer? customData) : base(key, tags, customData)
    {
        EnemyType = enemyType;
        Outside = outside;
