...
static class ItemRegistrationHandler
{
    internal static void Init()
    {
        LethalContent.Items.AddAutoTaggers(
            ...
            new SimpleAutoTagger<DawnItemInfo>(Tags.GeneralItemClassGroup, itemInfo => itemInfo.Item.spawnPositionTypes != null && itemInfo.Item.spawnPositionTypes.Where(itemGroup => itemGroup.name == "GeneralItemClass").Any()),
            new SimpleAutoTagger<DawnItemInfo>(Tags.SmallItemsGroup, itemInfo => itemInfo.Item.spawnPositionTypes != null && itemInfo.Item.spawnPositionTypes.Where(itemGroup => itemGroup.name == "SmallItems").Any()),
            new SimpleAutoTagger<DawnItemInfo>(Tags.TabletopItemsGroup, itemInfo => itemInfo.Item.spawnPositionTypes != null && itemInfo.Item.spawnPositionTypes.Where(itemGroup => itemGroup.name == "TabletopItems").Any()),
            new SimpleAutoTagger<DawnItemInfo>(Tags.TestItemGroup, itemInfo => itemInfo.Item.spawnPositionTypes != null && itemInfo.Item.spawnPositionTypes.Where(itemGroup => itemGroup.name == "TestItem").Any()),
