...
{
    internal DawnItemInfo(NamespacedKey<DawnItemInfo> key, List<NamespacedKey> tags, Item item, DawnScrapItemInfo? scrapItemInfo, DawnShopItemInfo? shopItemInfo, IDataContainer? customData) : base(key, tags, customData)
    {
        Item = item;
