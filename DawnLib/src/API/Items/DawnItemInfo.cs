...
{
    internal DawnItemInfo(NamespacedKey<DawnItemInfo> key, List<NamespacedKey> tags, Item item, DawnScrapItemInfo? scrapItemInfo, DawnShopItemInfo? shopItemInfo) : base(key, tags)
    {
        Item = item;
